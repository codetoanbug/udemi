...
export const COMMON_CURRICULUM_FIELDS = [
  "title",
  "object_index",
  "is_published",
  "sort_order",
...
export const CERTIFICATES_TYPES = [
  CERTIFICATE_TYPE_UDEMY,
  CERTIFICATE_TYPE_NASBA,
];

export const IS_ASSESSMENT_GUIDE_ENABLED_COURSE_LIST = [
  1025702, 1298780, 1360446, 1456464, 1546884, 1602900, 1754098, 1755264,
  1879018, 1921420, 1927250, 2015076, 2051741, 2059535, 1535678, 2193468,
  2196488, 2253706, 2327688, 2359992, 2360064, 2394982, 2533568, 2542943,
  2543649, 2645936, 2782102, 2813427, 3251302, 3827154, 567828, 625204, 684824,
  705264, 762616, 773214, 802574, 802576, 2301254, 1988542, 3336410, 2462140,
  345340, 2533568, 1361790, 1754098, 3125272, 4065250, 4008228,
];
