...
import {
  API_LECTURE_FIELDS,
  API_LECTURE_MEDIA_LICENSE_FIELDS,
} from "../lecture-view/constants";
...
export default class Lecture extends CurriculumItem {
  ...
  get titleIndex() {
    return this.isPublished
      ? `${this.objectIndex}.`
      : gettext("Unpublished lecture:");
  }

  get isVideo() {
    return (
      this.asset &&
      [ASSET_TYPE.VIDEO, ASSET_TYPE.VIDEO_MASHUP, ASSET_TYPE.AUDIO].includes(
        this.asset.type
      )
    );
  }
