 ...
 */
export default function udRenderReactComponents(
  container,
  className,
  Component,
  props = {}
...
export function _udRenderReactComponents(
  container,
  className,
  Component,
  props = {}
  ...
  matches.forEach((elem) => {
    const componentPropsString = elem.dataset.componentProps,
      componentPropsFromHtml = componentPropsString
        ? JSON.parse(componentPropsString)
        : {},
