...
export const ADMIN_LAB_ACCESS_LEVELS = [
  LAB_ACCESS_LEVEL.admin,
  LAB_ACCESS_LEVEL.admin_eng,
];
...
export const EDIT_FULL_AND_ADMIN_LAB_ACCESS_LEVELS =
  FULL_AND_ADMIN_LAB_ACCESS_LEVELS.concat([LAB_ACCESS_LEVEL.edit]);

export const TEST_CREATOR_EDIT_FULL_AND_ADMIN_LAB_ACCESS_LEVELS =
  EDIT_FULL_AND_ADMIN_LAB_ACCESS_LEVELS.concat([LAB_ACCESS_LEVEL.test_creator]);

export const TEST_CREATOR_FULL_AND_ADMIN_LAB_ACCESS_LEVELS =
  FULL_AND_ADMIN_LAB_ACCESS_LEVELS.concat([LAB_ACCESS_LEVEL.test_creator]);

export const ALL_INSTRUCTOR_LAB_ACCESS_LEVELS =
  EDIT_FULL_AND_ADMIN_LAB_ACCESS_LEVELS.concat([LAB_ACCESS_LEVEL.base]);
...
export const LAB_PENDING_STATUSES = [
  LAB_STATUS.pending_create,
  LAB_STATUS.pending_publish,
];
export const LAB_PREVIEWABLE_STATUSES = [
  LAB_STATUS.draft,
  LAB_STATUS.published,
];

export const LAB_BADGE_STATUSES = [
  LAB_STATUS.draft,
...
export const LAB_TRACKING_SELECTED_UI_REGION_MAPPING = Object.freeze({
  ...
  [LABS_DISCOVER_COMPONENTS.LABS_IN_SEARCH]:
    LAB_TRACKING_SELECTED_UI_REGION.LABS_IN_SEARCH,
  [LABS_DISCOVER_COMPONENTS.LABS_UNIT_LIHP]:
    LAB_TRACKING_SELECTED_UI_REGION.LABS_UNIT_LIHP,
  [LABS_DISCOVER_COMPONENTS.LABS_UNIT_TOPIC]:
    LAB_TRACKING_SELECTED_UI_REGION.LABS_UNIT_TOPIC,
  [LABS_DISCOVER_COMPONENTS.LAB_LISTING_PAGE]:
    LAB_TRACKING_SELECTED_UI_REGION.LABS_IN_PROGRESS_UNIT,
  [LABS_DISCOVER_COMPONENTS.LAB_OVERVIEW_PAGE]:
    LAB_TRACKING_SELECTED_UI_REGION.LABS_RELATED_UNIT,
  [UI_REGION.QUICK_PREVIEW]:
    LAB_TRACKING_SELECTED_UI_REGION.LAB_CARD_QUICK_PREVIEW,
  [UI_REGION.LAB_RECOMMENDATION]:
    LAB_TRACKING_SELECTED_UI_REGION.LAB_RECOMMENDATION,
});
...
export const LAB_TIME_LIMIT_MS = {
  [LAB_TYPE.workspace.key]:
    LAB_TIME_LIMIT_MINUTES[LAB_TYPE.workspace.key] * 60 * 1000,
  [LAB_TYPE.modular.key]:
    LAB_TIME_LIMIT_MINUTES[LAB_TYPE.modular.key] * 60 * 1000,
  [LAB_TYPE.dev_workspace.key]:
    LAB_TIME_LIMIT_MINUTES[LAB_TYPE.dev_workspace.key] * 60 * 1000,
};
...
export const PYTHON_RUN_TEST_ACTION_EVALUATORS = [
  "python3-cli",
  "python38-cli",
];
...
export const USER_CHECKED_SAFARI_SETTINGS_COOKIE_KEY =
  "user_checked_safari_settings";
...
export const LAB_TYPE_WORKSPACE = [
  LAB_TYPE.workspace.key,
  LAB_TYPE.dev_workspace.key,
];
...
export const DEVOPS_EVALUATORS_TERMINAL_EXPOSED_SERVICES = [
  "kubernetes",
  "docker",
];
...
export const LAB_VERSIONING_ENABLED_IN_LAB_MANAGE_EXPERIMENT_SET =
  "lab_versioning";
