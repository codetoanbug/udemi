...
export default class StandardPurchaseSection extends React.Component {
  static propTypes = {
    ...
    variation: PropTypes.oneOf(Object.values(PURCHASE_SECTION_VARIATION))
      .isRequired,
  ...
  get isIncentivesOnSidebar() {
    ...
    return (
      incentivesContext &&
      incentivesContext.placement === IncentivesPlacement.SIDEBAR
    );
  }
  ...
  get displayApplicableCoupons() {
    return (
      ...
      this.props?.store?.contexts.get("available_coupons")
    );
  }
    ...
    return (
      <div styleName="main-cta-container" data-purpose="purchase-section">
        ...
        {((!this.isIncentivesOnSidebar &&
          getDeviceType() !== DEVICE_TYPE_MOBILE) ||
