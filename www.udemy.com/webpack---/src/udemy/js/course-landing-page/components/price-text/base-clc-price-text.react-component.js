...
class InternalBaseClcPriceText extends React.Component {
  ...
  onView() {
    ...
    this.props.funnelLogContextStore.logAction("discount-price-logged", [
      funnelCourse,
    ]);
  }
  ...
  render() {
    ...
    const pricingResult = componentContext
      ? context.pricing_result
      : this.props.pricing_result;
    ...
    return (
      <div>
        <StaticPriceText
          ...
          percentDiscount={
            showDiscountPrice
              ? pricingResult.discount_percent_for_display
              : null
          }
          ...
          showPercentDiscount={
            this.props.show_percent_discount && showDiscountPrice
          }
...
export const BaseClcPriceText = withFunnelLogContextProvider()(
  InternalBaseClcPriceText
);
