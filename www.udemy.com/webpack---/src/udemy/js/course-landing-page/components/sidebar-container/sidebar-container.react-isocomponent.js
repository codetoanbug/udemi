...
import {
  TAB_CONTEXT_KEY,
  TABS,
} from "course-landing-page/components/purchase-team-tabs/constants";
...
export default class SidebarContainer extends React.Component {
  static propTypes = {
    ...
    sidebarPositionManagerStore: PropTypes.instanceOf(
  ...
  componentDidMount() {
    ...
    if (
      this.props.componentProps.purchaseSection.purchase_options_style !==
      "hardrule"
    ) {
      componentsToPopulate.push("buy_for_team");
    }
    this.props.store
      .getOrPopulate(componentsToPopulate)
  ...
  get positionClass() {
    return (
      this.positionToClassMap[
        this.props.sidebarPositionManagerStore?.position
      ] || ""
    );
  }
  ...
  updateComponentProps(componentProps) {
    this.componentProps.purchaseInfo =
      componentProps.base_purchase_section.purchaseInfo;
    this.componentProps.purchaseSection =
      componentProps.base_purchase_section.purchaseSection;
  ...
  render() {
    ...
    const { introductionAsset, buyForTeam, purchaseTabsContext } =
      this.componentProps;
          ...
          >
            ...
            <div className={styles.content}>
              <div className={styles["content-group"]}>
                ...
                >
                  {this.isLoading ||
                  this.context?.subscriptionPlan?.isLoading ? (
                    <PurchaseSectionContainerSkeleton
                      className={styles["purchase-section"]}
                    />
                  ) : (
                    ...
                    >
                      {this.isLoading ? (
                        ...
                        <div className={styles["buy-for-team"]}>
                          <BuyForTeam {...buyForTeam.data} {...restProps} />
                        </div>
                      )}
                    </ClientSideRender>
                  </div>
