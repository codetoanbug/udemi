...
import {
  ReportAbuseDesktop,
  ReportAbuseMobile,
} from "course-landing-page/components/report-abuse/";
import {
    ...
    return (
      <div className={this.props.className}>
        <p styleName="review-feedback__title" data-purpose="helpfulness-prompt">
          {value
            ? REVIEW_FEEDBACK_MESSAGES.SUCCESS
            : REVIEW_FEEDBACK_MESSAGES.TITLE}
        </p>
          ...
          {Object.keys(options).map((key) => {
            ...
            return (
              <HelpfulButton
                ...
                className={
                  styles[`review-feedback__actions-${option.className}`]
                }
                icon={option.icon}
