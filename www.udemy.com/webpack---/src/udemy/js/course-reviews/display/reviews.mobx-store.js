...
export default class ReviewsStore {
  ...
  fetchReviews({
    shouldAppend = false,
    callback = this.onReviewsFetched,
  } = {}) {
    ...
    const params = {
      ...
      "fields[user]":
        "@min,image_50x50,initials,public_display_name,tracking_id",
  ...
  renderContent(content, shouldUseSeparateParagraphs = true) {
    return makeRenderContent(this.searchedTerm)(
      content,
      shouldUseSeparateParagraphs
    );
  }
