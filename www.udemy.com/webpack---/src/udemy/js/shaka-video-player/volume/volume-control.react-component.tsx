...
export class VolumeControl extends React.Component {
    ...
    get volumeStore() {
        // @ts-expect-error TS(2339) FIXME: Property 'videoPlayerStore' does not exist on type... Remove this comment to see the full error message
    ...
    toggleMuted = () => {
        ...
        const storagedVolume = localStorage.getItem('lastVolume') as any;
