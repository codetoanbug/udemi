...
function getMajorVersion(versionString: any) {
    if (!versionString) {
        return;
    }
...
export const parseSpriteImageLink = (imgLocation: any, basePath: any) => {
...
parsedUserAgent.browser.version = getMajorVersion(parsedUserAgent.browser.version);

parsedUserAgent.os.version = getMajorVersion(parsedUserAgent.os.version);
