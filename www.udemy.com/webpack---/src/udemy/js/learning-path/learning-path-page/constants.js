...
export const LEARNING_PATH_ERROR_MESSAGES = Object.freeze({
  ...
  get UNABLE_TO_REMOVE_ITEM() {
    return gettext(
      "An error occurred while removing content from the learning path."
    );
  },
  ...
  get UNABLE_TO_ADD_CONTENT() {
    return gettext(
      "An error occurred while adding content to the learning path."
    );
  },
...
export const LEARNING_PATH_SECTION_API_FIELDS = [
  "id",
  "title",
  "description",
  "items",
  ...
  [PUBLIC_VISIBILITY_OPTION]: {
    ...
    get content() {
      return [
        ...
        gettext(
          "This path will be listed under 'All paths' in the learning paths area."
        ),
...
export const COURSE_EDITABLE_CONTENT_TYPES = [
  COURSE_CONTENT_TYPE,
  COURSE_PORTION_CONTENT_TYPE,
];
export const UDEMY_ENROLLABLE_CONTENT_TYPES = [
  COURSE_CONTENT_TYPE,
  COURSE_PORTION_CONTENT_TYPE,
];
...
export const AUTO_ENROLL_INFO_MESSAGE = {
  get TEXT() {
    return gettext(
      "You are automatically enrolled in a path when you start learning."
    );
  },
};
