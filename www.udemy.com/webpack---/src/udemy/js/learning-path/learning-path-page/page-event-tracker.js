  ...
  deletedCourseToBeRetired(courseId) {
    Tracker.publishEvent(
      new LearningPathRemovedCourseAlertActionEvent({
        ...
        courseId,
        action:
          COURSE_RETIREMENT_ALERT_EVENT_TRACKING_ACTIONS.DELETED_TO_BE_RETIRED_COURSE,
  ...
  clickedShowCourseDetails(courseId) {
    Tracker.publishEvent(
      new LearningPathRemovedCourseAlertActionEvent({
        ...
        courseId,
        action:
          COURSE_RETIREMENT_ALERT_EVENT_TRACKING_ACTIONS.SHOW_COURSE_DETAILS,
        alertType: COURSE_RETIREMENT_ALERT_TYPES.RETIRED,
      })
    );
  }
  ...
  addedCourseAlternative(courseId, alertType, alternativeCourseId) {
    Tracker.publishEvent(
      new LearningPathRemovedCourseAlertActionEvent({
        ...
        courseId,
        action:
          COURSE_RETIREMENT_ALERT_EVENT_TRACKING_ACTIONS.ADDED_COURSE_ALTERNATIVE,
        alertType,
        alternativeCourseId,
      })
    );
