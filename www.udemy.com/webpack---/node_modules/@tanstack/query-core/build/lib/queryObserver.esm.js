...
class QueryObserver extends Subscribable {
  ...
  setOptions(options, notifyOptions) {
    ...
    if (
      ...
      typeof (options == null ? void 0 : options.isDataEqual) !== "undefined"
    ) {
      this.client
        .getLogger()
        .error(
  ...
  fetch(fetchOptions) {
    ...
    return this.executeFetch({
      ...fetchOptions,
      cancelRefetch:
        (_fetchOptions$cancelR = fetchOptions.cancelRefetch) != null
  ...
  updateResult(notifyOptions) {
    ...
    const shouldNotifyListeners = () => {
      ...
      const includedProps = new Set(
        notifyOnChangeProps != null ? notifyOnChangeProps : this.trackedProps
      );
  ...
  notify(notifyOptions) {
    notifyManager.batch(() => {
      ...
      if (notifyOptions.onSuccess) {
        ...
        (_this$options$onSucce = (_this$options = this.options).onSuccess) ==
        null
          ? void 0
          : _this$options$onSucce.call(_this$options, this.currentResult.data);
        (_this$options$onSettl = (_this$options2 = this.options).onSettled) ==
        null
          ? void 0
        ...
        (_this$options$onError = (_this$options3 = this.options).onError) ==
        null
          ? void 0
        ...
        (_this$options$onSettl2 = (_this$options4 = this.options).onSettled) ==
        null
          ? void 0
