...
var getClassNameForNamespacedStyleName =
  function getClassNameForNamespacedStyleName(
    styleName,
    styleModuleImportMap,
    handleMissingStyleNameOption
  ) {
    // Note:
    ...
    var handleMissingStyleName =
      handleMissingStyleNameOption || DEFAULT_HANDLE_MISSING_STYLENAME_OPTION;
...
exports.default = function (styleNameValue, styleModuleImportMap, options) {
  ...
  var handleMissingStyleName =
    (options && options.handleMissingStyleName) ||
  ...
  return styleNameValue
    ...
    .map(function (styleName) {
      ...
      if (!styleModuleMap[styleName]) {
        if (handleMissingStyleName === "throw") {
          throw new Error(
            "Could not resolve the styleName '" + styleName + "'."
          );
        }
