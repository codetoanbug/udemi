...
export var QueryObserver = /*#__PURE__*/ (function (_Subscribable) {
  ...
  _proto.updateStaleTimeout = function updateStaleTimeout() {
    ...
    this.staleTimeoutId = setTimeout(function () {
      if (!_this4.currentResult.isStale) {
        ...
        _this4.notify({
          listeners: _this4.shouldNotifyListeners(
            prevResult,
            _this4.currentResult
          ),
          cache: true,
        });
      }
  ...
  _proto.updateRefetchInterval = function updateRefetchInterval() {
    ...
    this.refetchIntervalId = setInterval(function () {
      if (
        _this5.options.refetchIntervalInBackground ||
  ...
  _proto.getNewResult = function getNewResult(willFetch) {
    ...
    if (
      ...
      ((_this$previousQueryRe = this.previousQueryResult) == null
        ? void 0
        : _this$previousQueryRe.isSuccess) &&
      status !== "error"
    ) {
      ...
      if (
        this.currentResult &&
        state.data ===
          ((_this$currentResultSt = this.currentResultState) == null
            ? void 0
            : _this$currentResultSt.data)
      ) {
        ...
        if (this.options.structuralSharing !== false) {
          ...
          data = replaceEqualDeep(
            (_this$currentResult = this.currentResult) == null
              ? void 0
              : _this$currentResult.data,
            data
          );
        }
      }
