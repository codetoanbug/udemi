...
!(function () {
  ...
  (e = this),
      ...
      return (function () {
        var e = {
            ...
            721: function (e, t, r) {
              ...
              var d = u().log,
                c = u().utils.secondsToMs,
                f = u().utils.assign,
                p = u().utils.getComputedStyle,
                _ = u().utils.extractHostname,
                v = function (e, t) {
                  var r =
                    arguments.length > 2 && void 0 !== arguments[2]
                      ? arguments[2]
                      : n().shaka;
                  if ("object" !== l(e) || void 0 === e.constructor.version)
                    return (
                      d.warn(
                        "[shakaPlayer-mux] You must provide a valid shakaPlayer to initShakaPlayerMux."
                      ),
                      {
                        emit: function () {
                          d.warn(
                            "[shakaPlayer-mux] emit is a no-op because initShakaPlayerMux was not initialized correctly"
                          );
                        },
                        loadErrorHandler: function () {
                          d.warn(
                            "[shakaPlayer-mux] loadErrorHandler is a no-op because initShakaPlayerMux was not initialized correctly"
                          );
                        },
                      }
                    );
                  var a = function (t) {
                      return e.getMediaElement() && e.getMediaElement()[t];
                    },
                    i = function (t) {
                      var r = e.getMediaElement();
                      if (r) return parseInt(p(r, t));
                    },
                    s = function () {
                      var e = a("preload");
                      return "auto" === e || "metadata" === e;
                    };
                  function v() {
                    var t =
                      o().fullscreenElement ||
                    ...
                    return t ? t === e.getMediaElement() : void 0;
                  }
                  var h = { automaticErrorTracking: !0 };
                  (t = f(h, t)).data = f(
                    {
                      player_software_name: "Shaka Player",
                      player_software_version: e.constructor.version,
                      player_mux_plugin_name: "shakaplayer-mux",
                      player_mux_plugin_version: "5.10.0",
                    },
                    t.data
                  );
                  var m = u().utils.generateShortID();
                  (e.mux = {}),
                    (e.mux.emit = function (e, t) {
                      u().emit(m, e, t);
                    }),
                    (t.getPlayheadTime = function () {
                  ...
                  var y = [
                    ...
                    T = function () {
                      ...
                      if (!t)
                        return d.warn(
                          "[shakaPlayer-mux] Unable to getMediaElement() on shaka.Player instance when attempting to attachMediaElementEvents()"
                        );
                      y.forEach(function (r) {
                        (b[r] = function () {
                          var a = {};
                          "timeupdate" === r &&
                            (a.player_playhead_time = t.currentTime),
                            e.mux.emit(r, a);
                        }),
                          t.addEventListener(r, b[r], !1);
                      });
                    };
                  g.onstatechange = function (t) {
                    !w && e.getMediaElement() && T(),
                      "load" === t.state && e.mux.emit("playerready");
                  };
                  var k = {
                    ...
                    x = function () {
                      ...
                      t &&
                        ...
                        ((k = t), e.mux.emit("renditionchange", t));
                    };
                  (g.adaptation = function () {
                    x();
                  }),
                    (g.variantchanged = function () {
                      x();
                    }),
                    e.addEventListener("onstatechange", g.onstatechange),
                    e.addEventListener("adaptation", g.adaptation),
                    e.addEventListener("variantchanged", g.variantchanged);
                  var O = function (e) {
                      var t, a;
                      ...
                      var n =
                        ...
                        void 0 === a
                          ? void 0
                          : a.Code;
                      for (var i in n) if (n[i] === e.code) return i;
                      return e.code;
                    },
                    D = function (t) {
                      var r;
                      2 === (null == t ? void 0 : t.severity) &&
                        e.mux.emit("error", {
                          player_error_code: t.code,
                          player_error_message: O(t),
                  ...
                  (g.error = function (e) {
                    if (t.automaticErrorTracking) {
                      var r = e.detail;
                      D(r);
                    }
                  }),
                    e.addEventListener("error", g.error),
                    (e.mux.destroy = function () {
                      Object.keys(g).forEach(function (t) {
                        e.removeEventListener(t, g[t]), delete g[t];
                      }),
                        Object.keys(b).forEach(function (t) {
                          var r = e.getMediaElement();
                          r && r.removeEventListener(t, b[t], !1), delete b[t];
                        }),
                        e.mux.emit("destroy");
                    });
                  var P = { 0: "manifest", 1: "media" };
                  e
                    .getNetworkingEngine()
                    .registerResponseFilter(function (t, r) {
                      var a = u().utils.now();
                      if (!r.fromCache) {
                        var n = P[t && t.toString()];
                        if (t) {
                          var i = {
                            request_bytes_loaded: r.data.byteLength,
                            request_hostname: _(r.uri),
                            request_url: r.uri,
                            request_response_headers: r.headers,
                            request_type: n,
                            request_start: r.timeMs ? a - r.timeMs : void 0,
                            request_response_end: a,
                          };
                          e.mux.emit("requestcompleted", i);
                        }
                      }
                    }),
                    u().init(m, t);
                  var S = { emit: e.mux.emit, loadErrorHandler: D };
                  return S;
                };
              (v.utils = u().utils), (t.default = v);
            },
            153: function (e, t, r) {
              var a,
                n =
                      ...
                      728: function (e, t, r) {
                              ...
                              .forEach(function (e) {
                                if (e) {
                                  var r = e.split(": "),
                                    a = r.shift();
                                  a &&
                                    (T.indexOf(a.toLowerCase()) >= 0 ||
                                      0 ===
                                        a.toLowerCase().indexOf("x-litix-")) &&
                                    (t[a] = r.join(": "));
                                }
                              }),
                            t
                        ...
                        var x = function (e) {
                          ...
                          for (var r in e) {
                            ...
                            -1 !== a["DATA-ID"].search("io.litix.data.") &&
                              (t[a["DATA-ID"].replace("io.litix.data.", "")] =
                                a.VALUE);
                          }
                          return t;
                        };
                        ...
                        var S = function (e) {
                          ...
                          q = function (e) {
                            if (
                              e &&
                              "function" == typeof e.getAllResponseHeaders
                            )
                            ...
                            var a,
                              ...
                              f =
                                "function" == typeof t.getMetricsFor
                                  ...
                                  : t
                                      .getDashMetrics()
                                      .getHttpRequests(n.mediaType);
                            return (
                              f.length > 0 &&
                                (a = k(f[f.length - 1]._responseHeaders || "")),
                              {
                                requestStart: u,
                                  ...
                                  value: function (e, t) {
                                    ...
                                    r &&
                                      r.forEach(function (e, a) {
                                        e._eventEmitterGuid ===
                                          t._eventEmitterGuid && r.splice(a, 1);
                                      });
                                  },
                                },
                                {
                        ...
                        var J = (function () {
                          function e(t) {
                            ...
                            t.on("playbackheartbeatend", n),
                              ...
                              t.on("viewinit", function () {
                                (r._playbackTimeTrackerLastPlayheadPosition =
                                  -1),
                                  (r._lastTime = _.now()),
                                  (r._isAdPlaying = !1),
                              ...
                              var r,
                                ...
                                n = function (e) {
                                  if (r) {
                                    ...
                                    g(t.data, "view_rebuffer_duration", a),
                                      (r = e.viewer_time),
                                  ...
                                  value: function (e, t) {
                                    ...
                                    if (this._rebuffering)
                                      ...
                                      "number" ==
                                        ...
                                        a > 0 &&
                                        n - a >
                                          this.pm.minimumRebufferDuration &&
                                        ((this._lastCheckedTime = null),
                                        this.pm.emit("rebufferstart", {
                                          viewer_time:
                                            this._lastPlayheadTimeUpdatedTime,
                              ...
                              t.on(e, function () {
                                if (
                                  ...
                                  var a = Math.min(
                                    ...
                                    n = Math.max(0, a - 1),
                                    i = Math.max(0, 1 - a);
                                  (t.data.view_max_upscale_percentage =
                                    Math.max(
                                    ...
                                    g(t.data, "view_total_upscaling", n * e),
                        ...
                        var se = (function (e, t, r) {
                          ...
                          t.on("seeking", function (e, i) {
                            Object.assign(t.data, i),
                              r.isSeeking && i.viewer_time - a <= 2e3
                                ? (a = i.viewer_time)
                                : (r.isSeeking && n(),
                                  (r.isSeeking = !0),
                                  (a = i.viewer_time),
                                ...
                                },
                                {
                                  ...
                                  value: function (e) {
                                    for (
                                      ...
                                      if (
                                        this._adRequests[t].ad_request_id === e
                                      )
                        ...
                        var Ie = {
                          ...
                          je = "https://img.litix.io",
                          Ce = function (e) {
                            var t =
                              arguments.length > 1 && void 0 !== arguments[1]
                                ? arguments[1]
                                : {};
                            (this._beaconUrl = e || je),
                              (this._eventQueue = []),
                        ...
                        (Ce.prototype.queueEvent = function (e, t) {
                          ...
                          (Ce.prototype._sendBeaconQueue = function () {
                            ...
                            if (!this._postInFlight) {
                              ...
                              var r = this._createPayload(t),
                                a = _.now();
                              Me(this._beaconUrl, r, !1, function (r, n) {
                                n
                          ...
                          (Ce.prototype._startBeaconSending = function () {
                            ...
                            n().clearTimeout(this._sendTimeout),
                              this.destroyed ||
                                (this._sendTimeout = n().setTimeout(
                                  function () {
                                    e._eventQueue.length &&
                                      e._sendBeaconQueue(),
                              ...
                              var a,
                                ...
                                b =
                                  ...
                                  void 0 !== arguments[2]
                                    ...
                                    : {};
                              We(this, e),
                                Ve(this, "previousBeaconData", null),
                                Ve(this, "lastEventTime", 0),
                                Ve(this, "rateLimited", !1),
                                (this.mux = t),
                                (this.envKey = r),
                                (this.options = b),
                                (this.eventQueue = new He(
                                  xe(this.envKey, this.options)
                                )),
                                (this.sampleRate =
                                  null !== (a = this.options.sampleRate) &&
                                  void 0 !== a
                                    ? a
                                    : 1),
                                (this.disableCookies =
                                ...
                                (this.respectDoNotTrack =
                                  null !==
                                    (o = this.options.respectDoNotTrack) &&
                                  void 0 !== o &&
                                  o),
                                ...
                                (this.pageLevelData = {
                                  ...
                                  viewer_os_architecture:
                                    ...
                                    void 0 === v
                                      ...
                                      : v.architecture,
                                  viewer_os_version:
                                    null === (h = this.options.platform) ||
                                    void 0 === h ||
                                    null === (m = h.os) ||
                                    void 0 === m
                                      ? void 0
                                      : m.version,
                                  viewer_connection_type: Pe(),
                                  page_url:
                                    null === n() ||
                                    void 0 === n() ||
                                    null === (y = n().location) ||
                                    ...
                                    if (e && null != t && t.view_id) {
                                      ...
                                      var u =
                                          ...
                                          void 0 !== r
                                            ...
                                            : 0) >= this.sampleRate,
                                        l = Re(
                                          this._deduplicateBeaconData(e, s)
                                        );
                                      if (
                                        ((this.lastEventTime =
                                          this.mux.utils.now()),
                            ...
                            if (
                              ...
                              o++,
                                ...
                                u > 0 &&
                                  ...
                                  (t.data.view_average_request_latency =
                                    r / o));
                            }
                          }),
                          ...
                          dt = (function (e) {
                            ...
                            function n(e, t, r) {
                              ...
                              !(function (e, t) {
                                ...
                                ((o =
                                  a.call(this)).DOM_CONTENT_LOADED_EVENT_END =
                                  y()),
                              ...
                              return (
                                ...
                                (o.errorTracker = new G(st(o))),
                                new me(st(o)),
                                (o.seekingTracker = new se(st(o))),
                                (o.playheadTime = new K(st(o))),
                                (o.playbackHeartbeat = new B(st(o))),
                                new ie(st(o)),
                                (o.watchTimeTracker = new Q(st(o))),
                                new J(st(o)),
                            ...
                            return (
                              ...
                              (r = [
                                ...
                                },
                                {
                                  ...
                                  value: function (e, t) {
                                    var r = this;
                                    Object.keys(this.data).forEach(function (
                                      e
                                    ) {
                                      0 === e.indexOf("video_") &&
                                        delete r.data[e];
                                        ...
                                        : ((this.hlsjs = e.hlsjs),
                                          (function (e, t, r) {
                                            ...
                                            if (m()) {
                                              ...
                                              r.on(a.Events.LEVEL_SWITCHED, h),
                                                (r._stopMuxMonitor =
                                                  function () {
                                                    r.off(
                                                      a.Events.MANIFEST_LOADED,
                                                      u
                                                    ),
                                                      r.off(
                                                        a.Events.LEVEL_LOADED,
                                                        l
                                                      ),
                                                      r.off(
                                                        a.Events
                                                      ...
                                                      r.off(
                                                        a.Events.FRAG_LOADED,
                                                        c
                                                      ),
                                                      r.off(
                                                        a.Events.FRAG_CHANGED,
                                                        f
                                                      ),
                            ...
                            if ("#" !== a[0])
                              ...
                              switch (a) {
                                case "#EXT-X-TARGETDURATION":
                                  ...
                                  (this.manifest.targetDuration = n),
                                    this.setHoldBack();
                                  break;
                                case "#EXT-X-PART-INF":
                                  wt(this.manifest, r),
                        ...
                        var wt = function (e, t) {
                            var r,
                              a = Tt(t[0].replace("#EXT-X-", ""));
                            Ot(t[1])
                              ? ((r = {}), (r = Object.assign(xt(t[1]), r)))
                              : (r = kt(t[1])),
                              (e[a] = r);
                          },
                          Tt = function (e) {
                          ...
                          Pt = function (e) {
                            ...
                            if (e) {
                              var r = e.search(",");
                              return (
                                [e.slice(0, r), e.slice(r + 1)].forEach(
                                  function (e, r) {
                                    for (
                                      var a = e
                                          .replace(/['"]+/g, "")
                                    ...
                                    return a
                                      ? "video" !== o && "audio" !== o
                                        ...
                                        : ((a.muxId = n.muxId),
                                          ...
                                          delete n.mux.listeners,
                                          Object.keys(a.mux.listeners).forEach(
                                            function (e) {
                                              n.removeEventListener(
                                                e,
                                                a.mux.listeners[e],
                          ...
                          (a = function () {
                            ...
                            function s(t, r) {
                              for (var n = 0; n < a.length; n++) {
                                var i = a[n];
                                this[i] =
                                  n < t ? e : this.methodFactory(i, t, r);
                              }
                              this.log = this.debug;
                            }
                            function u(e, r, a) {
    ...
    "object" == typeof exports && "object" == typeof module
      ...
      ? (exports.initShakaPlayerMux = t())
      : (e.initShakaPlayerMux = t());
})();
