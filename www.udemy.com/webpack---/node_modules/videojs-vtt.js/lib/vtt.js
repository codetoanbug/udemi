...
var TEXTAREA_ELEMENT =
  document.createElement && document.createElement("textarea");
...
function BoxPosition(obj) {
  ...
  if (obj.div) {
    ...
    lh = rects
      ? Math.max((rects[0] && rects[0].height) || 0, obj.height / rects.length)
      : 0;
  }
  this.left = obj.left;
...
function moveBoxToLinePosition(window, styleBox, containerBox, boxPositions) {
  ...
  if (cue.snapToLines) {
    ...
    if (linePos < 0) {
      position +=
        cue.vertical === "" ? containerBox.height : containerBox.width;
      axis = axis.reverse();
    }
