...
(function (global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ...
    : ((global =
      ...
      (global.muxjs = factory(global.window)));
  ...
  _AdtsStream = function AdtsStream(handlePartialSegments) {
    ...
    this.push = function (packet) {
      ...
      while (i + 7 < buffer.length) {
        ...
        adtsFrameDuration =
          (sampleCount * ONE_SECOND_IN_TS$4) /
          ADTS_SAMPLING_FREQUENCIES$1[(buffer[i + 2] & 0x3c) >>> 2]; // If we don't have enough data to actually finish this ADTS frame,
  ...
  moov = function moov(tracks) {
    ...
    return box.apply(
      null,
      [types.moov, mvhd(0xffffffff)].concat(boxes).concat(mvex(tracks))
    );
  };
  ...
  var scaleTime = function scaleTime(
    presentationTime,
    timescale,
    timeDelta,
    offset
  ) {
    return presentationTime || presentationTime === 0
      ? presentationTime / timescale
      : offset + timeDelta / timescale;
  };
  /**
  ...
  var isValidEmsgBox = function isValidEmsgBox(version, emsg) {
    ...
    var isValidV0Box =
      version === 0 && isDefined(emsg.presentation_time_delta) && hasScheme;
    var isValidV1Box =
      version === 1 && isDefined(emsg.presentation_time) && hasScheme; // Only valid versions of emsg are 0 and 1
  ...
  var typedArrayIndexOf$1 = function typedArrayIndexOf(
    typedArray,
    element,
    fromIndex
  ) {
  ...
  var typedArrayIndexOf = typedArray.typedArrayIndexOf,
    ...
    frameParsers = {
      ...
      "W*": function W(frame) {
        ...
        frame.url = parseIso88591$1(frame.data, 0, frame.data.length).replace(
          /\0.*$/,
          ""
        );
      },
  ...
  startTime = function startTime(timescale, fragment) {
    ...
    var lowestTime = trafs.reduce(function (acc, traf) {
      ...
      var id = toUnsigned(
        (tfhd[4] << 24) | (tfhd[5] << 16) | (tfhd[6] << 8) | tfhd[7]
    ...
    return typeof lowestTime === "bigint" || isFinite(lowestTime)
      ? lowestTime
      : 0;
  };
  /**
  ...
  compositionStartTime = function compositionStartTime(timescales, fragment) {
      ...
      if (trun) {
        ...
        if (parsedTrun.samples && parsedTrun.samples.length) {
          compositionTimeOffset =
            parsedTrun.samples[0].compositionTimeOffset || 0;
        }
      }
    ...
    if (typeof baseMediaDecodeTime === "bigint") {
      compositionTimeOffset = window__default["default"].BigInt(
        compositionTimeOffset
      );
        ...
        if (codecBox) {
          ...
          if (/^[asm]vc[1-9]$/i.test(track.codec)) {
            ...
            if (
              ...
              track.codec +=
                "." +
                toHexString((codecConfig[20] >>> 2) & 0x3f).replace(/^0/, "");
            } else {
              // TODO: show a warning that we couldn't parse the codec
              // and are using the default
  ...
  getEmsgID3 = function getEmsgID3(segmentData, offset) {
    ...
    return emsgBoxes.map(function (data) {
      ...
      return {
        cueTime: emsg.scaleTime(
          parsedBox.presentation_time,
          parsedBox.timescale,
  ...
  var prefixWithSilence = function prefixWithSilence(
    ...
    if (audioAppendStartTs && videoBaseMediaDecodeTime) {
      ...
      audioGapDuration =
        ...
        Math.max(audioAppendStartTs, videoBaseMediaDecodeTime); // number of full frames in the audio gap
    ...
    track.baseMediaDecodeTime -= Math.floor(
      clock.videoTsToAudioTs(audioFillDuration, track.samplerate)
    );
  ...
  var trimAdtsFramesByEarliestDts = function trimAdtsFramesByEarliestDts(
    adtsFrames,
    track,
    earliestAllowedDts
  ) {
  ...
  var calculateTrackBaseMediaDecodeTime =
    function calculateTrackBaseMediaDecodeTime(track, keepOriginalTimestamps) {
  ...
  CaptionStream$1.prototype.push = function (event) {
    ...
    if (
      sei.payloadType !== captionPacketParser.USER_DATA_REGISTERED_ITU_T_T35
    ) {
      return;
  ...
  CaptionStream$1.prototype.dispatchCea608Packet = function (packet) {
    ...
    this.ccStreams_[
      (packet.type << 1) + this.activeCea608Channel_[packet.type]
    ].push(packet);
  };
    ...
    this.push = function (packet) {
      ...
      if (data === this.PADDING_) {
        ...
        if (this.mode_ === "popOn") {
          ...
          this.displayed_[this.row_].text = this.displayed_[
            this.row_
          ].text.slice(0, -1);
        }
  ...
  _MetadataStream = function MetadataStream(options) {
    ...
    if (settings.descriptor) {
      for (i = 0; i < settings.descriptor.length; i++) {
        this.dispatchType += ("00" + settings.descriptor[i].toString(16)).slice(
          -2
        );
      }
    }
    ...
    this.push = function (chunk) {
      ...
      do {
        // determine the number of bytes in this frame
        frameSize = parseId3.parseSyncSafeInteger(
  ...
  var _VideoSegmentStream$1,
    _AudioSegmentStream$1,
    _Transmuxer$1,
    _CoalesceStream;
  ...
  var addPipelineLogRetriggers = function addPipelineLogRetriggers(
    transmuxer,
    pipeline
  ) {
  ...
  var generateSegmentTimingInfo = function generateSegmentTimingInfo(
    baseMediaDecodeTime,
    startDts,
    startPts,
    endDts,
  ...
  _VideoSegmentStream$1 = function VideoSegmentStream(track, options) {
    ...
    this.getGopForFusion_ = function (nalUnit) {
      ...
      for (i = 0; i < this.gopCache_.length; i++) {
        ...
        if (
          !(track.pps && arrayEquals(track.pps[0], currentGopObj.pps[0])) ||
  ...
  _Transmuxer$1 = function Transmuxer(options) {
    ...
    this.setupAacPipeline = function () {
      ...
      pipeline.timedMetadataTimestampRolloverStream =
        new m2ts_1.TimestampRolloverStream("timed-metadata");
      ...
      pipeline.aacStream.on("data", function (data) {
        ...
        pipeline.audioSegmentStream = new _AudioSegmentStream$1(
          audioTrack,
          options
        );
      ...
      pipeline.elementaryStream.on("data", function (data) {
        ...
        if (data.type === "metadata") {
          ...
          if (videoTrack && !pipeline.videoSegmentStream) {
            pipeline.coalesceStream.numberOfTracks++;
            pipeline.videoSegmentStream = new _VideoSegmentStream$1(
              videoTrack,
              options
            );
            pipeline.videoSegmentStream.on(
              "log",
              self.getLogTrigger_("videoSegmentStream")
            );
            pipeline.videoSegmentStream.on(
              "timelineStartInfo",
    ...
    truns.forEach(function (trun) {
      ...
      samples.forEach(function (sample) {
        ...
        if (typeof currentDts === "bigint") {
          sample.pts =
            currentDts +
            window__default["default"].BigInt(sample.compositionTimeOffset);
  ...
  var parseCaptionNals = function parseCaptionNals(segment, videoTrackId) {
    ...
    mdatTrafPairs.forEach(function (pair) {
      ...
      if (videoTrackId === trackId && truns.length > 0) {
        ...
        captionNals[trackId].seiNals = captionNals[trackId].seiNals.concat(
          result.seiNals
        );
        captionNals[trackId].logs = captionNals[trackId].logs.concat(
          result.logs
        );
      }
    });
  ...
  _FlvTag = function FlvTag(type, extraData) {
    var // Counter if this is a metadata tag, nal start marker if this is a video
      ...
      videocodecidBytes =
        _FlvTag.videocodecidBytes || new Uint8Array("videocodecid".length),
      i;
    ...
    this.endNalUnit = function (nalContainer) {
      ...
      if (this.length === adHoc + 4) {
        ...
        if (nalContainer) {
          ...
          nalContainer.push(
            this.bytes.subarray(nalStart, nalStart + nalLength)
          );
        }
      }
  ...
  collectTimelineInfo = function collectTimelineInfo(track, data) {
    if (typeof data.pts === "number") {
      if (track.timelineStartInfo.pts === undefined) {
        ...
        track.timelineStartInfo.pts = Math.min(
    ...
    if (typeof data.dts === "number") {
      if (track.timelineStartInfo.dts === undefined) {
        ...
        track.timelineStartInfo.dts = Math.min(
  ...
  _AudioSegmentStream = function AudioSegmentStream(track) {
    ...
    this.flush = function () {
      ...
      while (adtsFrames.length) {
        ...
        if (
          track.extraData !== oldExtraData ||
          currentFrame.pts - lastMetaPts >= 1000
        ) {
  ...
  _Transmuxer = function Transmuxer(options) {
    ...
    timedMetadataTimestampRolloverStream = new m2ts_1.TimestampRolloverStream(
      "timed-metadata"
    );
    adtsStream = new adts();
    ...
    elementaryStream
      ...
      .pipe(coalesceStream$1); // if CEA-708 parsing is available, hook up a caption stream
      ...
      if (data.type === "metadata") {
        ...
        if (audioTrack && !audioSegmentStream) {
          ...
          if (videoSegmentStream) {
            videoSegmentStream.on(
              "keyframe",
              audioSegmentStream.onVideoKeyFrame
            );
          }
        }
      }
  ...
  var AudioSegmentStream = function AudioSegmentStream(track, options) {
    ...
    this.processFrames_ = function () {
      ...
      segmentEndPts +=
        frames.length * ((ONE_SECOND_IN_TS$1 * 1024) / track.samplerate);
      timingInfo = {
  ...
  var VideoSegmentStream = function VideoSegmentStream(track, options) {
    ...
    this.processNals_ = function (cacheLastFrame) {
      ...
      for (i = 0; i < frames.length; i++) {
        ...
        var mdat = mp4Generator.mdat(
          frameUtils.concatenateNalDataForFrame(frame)
        );
        trackDecodeInfo.clearDtsInfo(track);
  ...
  var tsPipeline = function tsPipeline(options) {
    ...
    pipeline.packet
      ...
      .pipe(pipeline.timestampRollover); // H264
    ...
    pipeline.elementary.on("data", function (data) {
      ...
      for (var i = 0; i < data.tracks.length; i++) {
        if (!pipeline.tracks[data.tracks[i].type]) {
          ...
          pipeline.tracks[
            data.tracks[i].type
          ].timelineStartInfo.baseMediaDecodeTime = options.baseMediaDecodeTime;
        }
      }

      if (pipeline.tracks.video && !pipeline.videoSegmentStream) {
        pipeline.videoSegmentStream = new videoSegmentStream(
          pipeline.tracks.video,
          options
        );
        pipeline.videoSegmentStream.on(
          "timelineStartInfo",
          function (timelineStartInfo) {
            if (pipeline.tracks.audio && !options.keepOriginalTimestamps) {
              pipeline.audioSegmentStream.setEarliestDts(
                timelineStartInfo.dts - options.baseMediaDecodeTime
              );
            }
          }
        );
    ...
    pipeline.metadataStream.on(
      "data",
      pipeline.trigger.bind(pipeline, "id3Frame")
    );
    return pipeline;
  };
  ...
  var aacPipeline = function aacPipeline(options) {
    var pipeline = {
      ...
      timedMetadataRollover: new m2ts_1.TimestampRolloverStream(
        "timed-metadata"
      ),
  ...
  var setupPipelineListeners = function setupPipelineListeners(
    pipeline,
    transmuxer
  ) {
    ...
    pipeline.on(
      "partialdone",
      transmuxer.trigger.bind(transmuxer, "partialdone")
    );
    pipeline.on(
      "endedtimeline",
      transmuxer.trigger.bind(transmuxer, "endedtimeline")
    );
    pipeline.on(
      "audioTimingInfo",
      transmuxer.trigger.bind(transmuxer, "audioTimingInfo")
    );
    pipeline.on(
      "videoTimingInfo",
      transmuxer.trigger.bind(transmuxer, "videoTimingInfo")
    );
        ...
        for (i = 8; entryCount; entryCount--) {
          if (result.version === 0) {
            result.edits.push({
              ...
              mediaRate:
                view.getUint16(i + 8) + view.getUint16(i + 10) / (256 * 256),
            });
            i += 12;
          } else {
            result.edits.push({
              ...
              mediaRate:
                view.getUint16(i + 16) + view.getUint16(i + 18) / (256 * 256),
            });
            i += 20;
          }
        }
      ...
      ctts: function ctts(data) {
        ...
        for (i = 8; entryCount; i += 8, entryCount--) {
          result.compositionOffsets.push({
            ...
            sampleOffset: view[result.version === 0 ? "getUint32" : "getInt32"](
              i + 4
            ),
          });
        }
          ...
          Object.keys(box)
            ...
            .map(function (key) {
              ...
              if (value instanceof Uint8Array || value instanceof Uint32Array) {
                var bytes = Array.prototype.slice
                  .call(
                    new Uint8Array(
                      value.buffer,
                      value.byteOffset,
  ...
  var tagTypes = {
    ...
    parseAVCTag = function parseAVCTag(tag, obj) {
      var avcPacketTypes = [
        ...
        compositionTime =
          (tag[1] & (parseInt("01111111", 2) << 16)) | (tag[2] << 8) | tag[3];
      obj = obj || {};
      obj.avcPacketType = avcPacketTypes[tag[0]];
      obj.CompositionTime =
        tag[1] & parseInt("10000000", 2) ? -compositionTime : compositionTime;
    ...
    parseAudioTag = function parseAudioTag(tag, obj) {
      ...
      obj.soundRate =
        samplingRateTable[(tag[0] & parseInt("00001100", 2)) >>> 2];
      obj.soundSize =
        (tag[0] & parseInt("00000010", 2)) >>> 1 ? "16-bit" : "8-bit";
  ...
  var parsePayloadUnitStartIndicator = function parsePayloadUnitStartIndicator(
    packet
  ) {
  ...
  var parsePmt = function parsePmt(packet) {
    ...
    sectionLength =
      ((packet[payloadOffset + 1] & 0x0f) << 8) | packet[payloadOffset + 2];
    tableEnd = 3 + sectionLength - 4; // to determine where the table is, we have to figure out how
    // long the program info descriptors are

    programInfoLength =
      ((packet[payloadOffset + 10] & 0x0f) << 8) | packet[payloadOffset + 11]; // advance the offset to the first entry in the mapping table
    ...
    while (offset < tableEnd) {
      ...
      programMapTable[((packet[i + 1] & 0x1f) << 8) | packet[i + 2]] =
  ...
  var videoPacketContainsKeyFrame = function videoPacketContainsKeyFrame(
    packet
  ) {
    var offset = 4 + parseAdaptionField(packet);
