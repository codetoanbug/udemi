...
var snippet = function snippet(_ref) {
  var orgId = _ref.orgId,
    ...
    script =
      _ref$script === void 0 ? "edge.fullstory.com/s/fs.js" : _ref$script;
...
var hasFullStoryWithFunction = function hasFullStoryWithFunction() {
  ...
  for (
    var _len = arguments.length, testNames = new Array(_len), _key = 0;
    _key < _len;
    _key++
  ) {
...
var guard = function guard(name) {
  return function () {
    if (window._fs_dev_mode) {
      var message = "FullStory is in dev mode and is not recording: ".concat(
        name,
        " method not executed"
      );
