...
var BrowserBackend = /** @class */ (function (_super) {
  ...
  BrowserBackend.prototype._setupTransport = function () {
    ...
    var transportOptions = __assign(
      __assign({}, this._options.transportOptions),
      {
    ...
    var api = initAPIDetails(
      transportOptions.dsn,
      transportOptions._metadata,
      transportOptions.tunnel
    );
