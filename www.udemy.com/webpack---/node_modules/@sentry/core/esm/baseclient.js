...
var BaseClient = /** @class */ (function () {
  ...
  BaseClient.prototype.flush = function (timeout) {
    var _this = this;
    return this._isClientDoneProcessing(timeout).then(function (
      clientFinished
    ) {
      return _this
        .getTransport()
  ...
  BaseClient.prototype._updateSessionFromEvent = function (session, event) {
    ...
    if (exceptions) {
      ...
      try {
        for (
          var exceptions_1 = __values(exceptions),
  ...
  BaseClient.prototype._prepareEvent = function (event, scope, hint) {
    ...
    var prepared = __assign(__assign({}, event), {
      event_id:
        event.event_id || (hint && hint.event_id ? hint.event_id : uuid4()),
    ...
    return result.then(function (evt) {
      if (evt) {
        ...
        evt.sdkProcessingMetadata = __assign(
          __assign({}, evt.sdkProcessingMetadata),
          {
            normalizeDepth:
              normalize(normalizeDepth) + " (" + typeof normalizeDepth + ")",
          }
        );
      }
  ...
  BaseClient.prototype._normalizeEvent = function (event, depth, maxBreadth) {
    ...
    normalized.sdkProcessingMetadata = __assign(
      __assign({}, normalized.sdkProcessingMetadata),
  ...
  BaseClient.prototype._applyIntegrationsMetadata = function (event) {
    ...
    if (integrationsArray.length > 0) {
      event.sdk = event.sdk || {};
      event.sdk.integrations = __spread(
  ...
  BaseClient.prototype._processEvent = function (event, hint, scope) {
    ...
    return this._prepareEvent(event, scope, hint)
      .then(function (prepared) {
        ...
        var isInternalException =
          hint && hint.data && hint.data.__sentry__ === true;
