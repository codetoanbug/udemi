...
export function createEventEnvelope(event, api) {
  ...
  var transactionSampling = (event.sdkProcessingMetadata || {})
    .transactionSampling;
  ...
  if (
    !(
      ...
      event.sdkProcessingMetadata.baseClientNormalized
    )
  ) {
    event.tags.skippedNormalization = true;
    event.extra.normalizeDepth = event.sdkProcessingMetadata
      ? event.sdkProcessingMetadata.normalizeDepth
      : "unset";
  }
