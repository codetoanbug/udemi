...
var SentryFullStory = /** @class */ (function () {
  ...
  SentryFullStory.prototype.setupOnce = function () {
    ...
    addGlobalEventProcessor(function (event$1, hint) {
      ...
      if (
        self &&
        event$1.type !== "transaction" &&
        _this.doesFullStoryExist()
      ) {
        ...
        event$1.contexts = __assign(__assign({}, event$1.contexts), {
          fullStory: {
            fullStoryUrl:
              getCurrentSessionURL(true) || "current session URL API not ready",
          },
        });
