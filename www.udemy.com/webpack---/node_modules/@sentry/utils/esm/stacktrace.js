...
export function createStackParser() {
  ...
  return function (stack, skipFirst) {
    ...
    try {
      for (
        var _c = __values(stack.split("\n").slice(skipFirst)), _d = _c.next();
        !_d.done;
        _d = _c.next()
      ) {
        var line = _d.value;
        try {
          for (
            var sortedParsers_1 = ((e_2 = void 0), __values(sortedParsers)),
              sortedParsers_1_1 = sortedParsers_1.next();
            !sortedParsers_1_1.done;
            sortedParsers_1_1 = sortedParsers_1.next()
          ) {
