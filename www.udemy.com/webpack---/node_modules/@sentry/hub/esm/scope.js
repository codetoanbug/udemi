...
var Scope = /** @class */ (function () {
  ...
  Scope.prototype.setExtra = function (key, extra) {
    var _a;
    this._extra = __assign(
      __assign({}, this._extra),
      ((_a = {}), (_a[key] = extra), _a)
    );
    this._notifyScopeListeners();
    return this;
  ...
  Scope.prototype.setContext = function (key, context) {
    ...
    if (context === null) {
      ...
      this._contexts = __assign(
        __assign({}, this._contexts),
        ((_a = {}), (_a[key] = context), _a)
      );
    }
    this._notifyScopeListeners();
    return this;
  ...
  Scope.prototype.addBreadcrumb = function (breadcrumb, maxBreadcrumbs) {
    ...
    this._breadcrumbs = __spread(this._breadcrumbs, [mergedBreadcrumb]).slice(
      -maxCrumbs
    );
    this._notifyScopeListeners();
    return this;
  ...
  Scope.prototype.applyToEvent = function (event, hint) {
    ...
    return this._notifyEventProcessors(
      __spread(getGlobalEventProcessors(), this._eventProcessors),
      event,
      hint
    );
  };
  ...
  Scope.prototype.setSDKProcessingMetadata = function (newData) {
    this._sdkProcessingMetadata = __assign(
      __assign({}, this._sdkProcessingMetadata),
      newData
    );
    return this;
  };
      ...
      if (event === null || typeof processor !== "function") {
        ...
        if (isThenable(result)) {
          void result
            .then(function (final) {
              return _this
                ._notifyEventProcessors(processors, final, hint, index + 1)
                .then(resolve);
            })
            .then(null, reject);
        } else {
