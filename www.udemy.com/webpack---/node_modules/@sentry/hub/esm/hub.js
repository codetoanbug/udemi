...
var Hub = /** @class */ (function () {
  ...
  Hub.prototype.captureException = function (exception, hint) {
    ...
    this._invokeClient(
      "captureException",
      exception,
      __assign(__assign({}, finalHint), { event_id: eventId })
    );
    return eventId;
  };
  /**
  ...
  Hub.prototype.captureEvent = function (event, hint) {
    ...
    this._invokeClient(
      "captureEvent",
      event,
      __assign(__assign({}, hint), { event_id: eventId })
    );
    return eventId;
  };
  /**
...
export function getActiveDomain() {
  IS_DEBUG_BUILD &&
    logger.warn(
      "Function `getActiveDomain` is deprecated and will be removed in a future version."
    );
