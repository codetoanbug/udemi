...
var _isLikely = {
  ...
  mp4: function mp4(bytes) {
    ...
    if (
      bytesMatch(bytes, CONSTANTS.mp4, {
        offset: 4,
      }) ||
    ...
    if (
      bytesMatch(bytes, CONSTANTS.moof, {
        offset: 4,
      }) ||
  ...
  avi: function avi(bytes) {
    return (
      bytesMatch(bytes, CONSTANTS.riff) &&
      bytesMatch(bytes, CONSTANTS.avi, {
        offset: 8,
      })
    );
  },
  wav: function wav(bytes) {
    return (
      bytesMatch(bytes, CONSTANTS.riff) &&
      bytesMatch(bytes, CONSTANTS.wav, {
        offset: 8,
      })
    );
  },
