(function (global) {
  ...
  function _wrapRegExp() {
    ...
    function BabelRegExp(re, flags, groups) {
      ...
      return (
        ...
        babelHelpers.setPrototypeOf(_this, BabelRegExp.prototype)
      );
    }
  ...
  function _temporalRef(val, name) {
    return val === babelHelpers.temporalUndefined
      ? babelHelpers.tdz(name)
      : val;
  }
  ...
  function _slicedToArray(arr, i) {
    return (
      ...
      babelHelpers.unsupportedIterableToArray(arr, i) ||
  ...
  function _toArray(arr) {
    return (
      ...
      babelHelpers.unsupportedIterableToArray(arr) ||
      babelHelpers.nonIterableRest()
    );
  }
  ...
  function _maybeArrayLike(next, arr, i) {
    if (arr && !Array.isArray(arr) && typeof arr.length === "number") {
      var len = arr.length;
      return babelHelpers.arrayLikeToArray(
        arr,
  ...
  function _unsupportedIterableToArray(o, minLen) {
    ...
    if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n))
      return babelHelpers.arrayLikeToArray(o, minLen);
  }
  ...
  function _createForOfIteratorHelper(o, allowArrayLike) {
    ...
    if (!it) {
      if (
        Array.isArray(o) ||
        (it = babelHelpers.unsupportedIterableToArray(o)) ||
  ...
  function _classPrivateFieldGet(receiver, privateMap) {
    var descriptor = babelHelpers.classExtractFieldDescriptor(
      receiver,
      privateMap,
      "get"
    );
  ...
  function _classPrivateFieldDestructureSet(receiver, privateMap) {
    ...
    return babelHelpers.classApplyDescriptorDestructureSet(
      receiver,
      descriptor
    );
  }

  babelHelpers.classPrivateFieldDestructureSet =
  ...
  babelHelpers.classStaticPrivateFieldDestructureSet =
  ...
  babelHelpers.classCheckPrivateStaticFieldDescriptor =
