...
var _getAssetPathFromRoute = _interop_require_default(
  require("../shared/lib/router/utils/get-asset-path-from-route")
);
...
class PageLoader {
  getPageList() {
    if (process.env.NODE_ENV === "production") {
      return (0, _routeLoader)
        ...
        .then((manifest) => manifest.sortedPages);
    } else {
  ...
  getDataHref(params) {
    ...
    const { pathname: asPathname } = (0, _parseRelativeUrl).parseRelativeUrl(
      asPath
    );
