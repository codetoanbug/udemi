...
function AppContainer({ children }) {
  return /*#__PURE__*/ _react.default.createElement(
    ...
    {
      fn: (
        error // TODO: Fix disabled eslint rule
      ) =>
...
function renderError(renderErrorProps) {
  ...
  return pageLoader
    ...
    .then(({ page: ErrorComponent, styleSheets }) => {
      return (lastAppProps == null ? void 0 : lastAppProps.Component) ===
        ErrorComponent
        ? import("../pages/_error")
            .then((errorModule) => {
    ...
    .then(({ ErrorComponent, styleSheets }) => {
      ...
      return Promise.resolve(
        ((ref = renderErrorProps.props) == null ? void 0 : ref.err)
          ? renderErrorProps.props
          : (0, _utils).loadGetInitialProps(App, appCtx)
      ).then(
        (
          initProps // TODO: Fix disabled eslint rule
        ) =>
          // eslint-disable-next-line @typescript-eslint/no-use-before-define
          doRender(
...
function doRender(input) {
  ...
  function onHeadCommit() {
    if (
      ...
      const currentHrefs = currentStyleTags.map((tag) =>
  ...
  onStart();
  const elem = /*#__PURE__*/ _react.default.createElement(
...
function _hydrate() {
  _hydrate = _async_to_generator(function* (opts) {
    ...
    try {
      const appEntrypoint = yield pageLoader.routeLoader.whenEntrypoint(
        "/_app"
      );
