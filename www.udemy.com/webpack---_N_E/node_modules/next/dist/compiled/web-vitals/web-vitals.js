    ...
    s = function (n, y, T) {
      try {
        if (PerformanceObserver.supportedEntryTypes.includes(n)) {
          ...
          return (
            C.observe(Object.assign({ type: n, buffered: !0 }, T || {})), C
          );
        }
      } catch (n) {}
    },
          ...
          n.forEach(function (n) {
            "first-contentful-paint" === n.name &&
              ...
              n.startTime < w.firstHiddenTime &&
                ((P.value = n.startTime - u()), P.entries.push(n), T(!0)));
          });
        },
        I =
          window.performance &&
    ...
    H = function (n) {
      ...
      if (T || V.length < 10 || n.duration > y.latency) {
        if (T) T.entries.push(n), (T.latency = Math.max(T.latency, n.duration));
          ...
          var C = { id: n.interactionId, latency: n.duration, entries: [n] };
          (W[C.id] = C), V.push(C);
        }
        V.sort(function (n, y) {
    ...
    O = function (n, y) {
      ...
      var C,
        ...
        a = function (n) {
            ...
            (n.interactionId && H(n), "first-input" === n.entryType) &&
              !V.some(function (y) {
                return y.entries.some(function (y) {
                  return (
                    n.duration === y.duration && n.startTime === y.startTime
                  );
                });
              }) &&
              H(n);
          ...
          var y,
            T = ((y = Math.min(V.length - 1, Math.floor(R() / 50))), V[y]);
          T &&
            T.latency !== w.value &&
            ((w.value = T.latency), (w.entries = T.entries), C());
        },
        P = s("event", a, { durationThreshold: y.durationThreshold || 40 });
