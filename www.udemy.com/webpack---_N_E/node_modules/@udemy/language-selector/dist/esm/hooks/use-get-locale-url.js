...
export function useGetLocaleUrl(currentUrl) {
  let useLangPrefixedUrls =
    arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
  const i18n = useI18n();
  const { Config } = useUDData();
  const getLocaleUrl = React.useCallback(
    (locale) => {
      var _ref, _serverOrClient$globa;
      ...
      const urlStr =
        (_ref =
          currentUrl !== null && currentUrl !== void 0
            ? currentUrl
            : (_serverOrClient$globa = serverOrClient.global.location) ===
                null || _serverOrClient$globa === void 0
            ? void 0
            : _serverOrClient$globa.pathname) !== null && _ref !== void 0
          ? _ref
          : "";
      ...
      if (
        Config.supported_languages.find((item) => item.lang === splitPath[1])
      ) {
      ...
      if (
        ...
        var _Config$supported_lan;
        const lang =
          (_Config$supported_lan = Config.supported_languages.find(
            (item) => item.locale === locale
          )) === null || _Config$supported_lan === void 0
            ? void 0
            : _Config$supported_lan.lang;
        path = `/${lang}${path}`;
      }
      return {
        path,
...
//# sourceMappingURL=use-get-locale-url.js.map
