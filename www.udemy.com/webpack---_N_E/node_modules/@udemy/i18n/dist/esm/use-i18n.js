...
function getGlobalI18nApi() {
  var _globalObj$UD, _globalObj$UD$request;
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  const globalObj = typeof window === "undefined" ? global : window;
  if (
    typeof globalObj.gettext !== "function" ||
    typeof ((_globalObj$UD = globalObj.UD) === null || _globalObj$UD === void 0
      ? void 0
      : _globalObj$UD.request) === "undefined"
  ) {
    return null;
  }
  const locale =
    (_globalObj$UD$request = globalObj.UD.request.locale) !== null &&
    _globalObj$UD$request !== void 0
      ? _globalObj$UD$request
      : "en_US";
  const api = {
