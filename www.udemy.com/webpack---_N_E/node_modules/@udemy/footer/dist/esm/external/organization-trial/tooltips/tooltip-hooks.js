  ...
  return {
    ...
    non_video_content_locked: {
      ...
      text(_ref9) {
        ...
        let firstPart = "";
        const assetType = item.assetType;
        const secondPart = gettext(
          "Buy Udemy Business to start taking them today."
        );
        if (item.quizType) {
...
export function useGetTooltipProps() {
   ...
   * @returns object
   */
  const getTooltipProps = function (type) {
    let params =
