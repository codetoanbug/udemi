...
export const LEFT_COURSE_TAKING_PAGE_EVENT =
  "limitedConsumptionTrial:leftCourseTakingPage";
export const CLICK_LECTURE_ON_CLP_EVENT =
  "limitedConsumptionTrial:clickedLectureOnClp";

// Clicking "Download our list of course" from the PreOnboardingTrialBanner
export const DOWNLOAD_COURSE_LIST_EVENT =
  "limitedConsumptionTrialV2:bannerCourseListDownload";
// Clicking "Invite them now" from the PreOnboardingTrialBanner
export const INVITE_THEM_NOW_EVENT =
  "limitedConsumptionTrialV2:inviteThemNowClick";
