 ...
 */
export function expiringLocalStorageWithKeyTTLs(namespace, name, TTL) {
  ...
  return {
    ...
    set(key, value) {
      if (baseStorage.size() < maximumStorageSize) {
        ...
        const item = {
          value,
          valid_until: currentDate.getTime(),
        };
...
//# sourceMappingURL=ud-expiring-local-storage-with-key-ttls.js.map
