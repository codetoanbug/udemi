...
export const initLargestContentfulPaint = (reportFn, metrics) => {
  let isDisconnected = false;
  const lcpObserver = po("largest-contentful-paint", (performanceEntries) => {
  ...
  ["keydown", "click"].forEach((type) => {
    window.addEventListener(type, safeDisconnect, {
      once: true,
      capture: true,
    });
  });
