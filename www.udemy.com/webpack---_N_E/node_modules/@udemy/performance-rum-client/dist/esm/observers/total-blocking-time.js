...
export const initTotalBlockingTime = (reportFn, metrics) => {
  let isDisconnected = false;
  const longtaskObserver = po("longtask", (performanceEntries) => {
    performanceEntries.forEach((entry) => {
      if (entry.name !== "self" || entry.startTime < metrics.fcp) {
        return;
      }
...
//# sourceMappingURL=total-blocking-time.js.map
