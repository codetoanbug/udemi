 ...
 */
export function initMarksAndMeasures(reportFn) {
  ...
  const marksObserver = po("mark", (performanceEntries) => {
    processPerformanceMarksAndMeasures(
      performanceEntries,
      reportFn,
      entryHasBeenProcessedMap
    );
  });
  const measuresObserver = po("measure", (performanceEntries) => {
    processPerformanceMarksAndMeasures(
      performanceEntries,
      reportFn,
      entryHasBeenProcessedMap
...
//# sourceMappingURL=marks-and-measures.js.map
