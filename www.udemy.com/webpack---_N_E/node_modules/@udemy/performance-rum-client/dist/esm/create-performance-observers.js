...
export const createPerformanceObservers = (
  ...
  disconnectTasks.push(
    initFirstPaints(generalReporterFn, metrics, () => {
      ...
      disconnectTasks.push(initTotalBlockingTime(generalReporterFn, metrics));
  ...
  return () => {
    if (disconnectTasks) {
      disconnectTasks.forEach((disconnectTask) => {
      ...
      const trackedResources =
        wUD && wUD.performance && wUD.performance._trackedResources;
      if (trackedResources) {
        trackedResources.forEach((name) => {
...
//# sourceMappingURL=create-performance-observers.js.map
