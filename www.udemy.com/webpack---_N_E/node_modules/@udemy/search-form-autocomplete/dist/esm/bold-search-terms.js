...
function createSearchTermRegex(term) {
  ...
  const specialCharactersPrefix =
    "(\\s|^[\x21-\x2f\x3a-\x40\x5b-\x60\x7b-\x7e]*)";
  return new RegExp(
    `(${specialCharactersPrefix}${escapeRegex(escapeHtml(term))})`,
    "ig"
  );
}
export function boldSearchTerms(text, searchPhrase) {
...
//# sourceMappingURL=bold-search-terms.js.map
