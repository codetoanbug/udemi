...
function udLiteTrackDiscoveryImpression(_ref, _ref2) {
  let { item } = _ref;
  let { backendSource, index } = _ref2;
...
function trackDiscoveryImpression(item, backendSource, index) {
  let { relatedSourceId = null, relatedSourceType = null } =
...
const trackAutoCompleteResultClick = (position, autoCompleteResult) => {
  ...
  const alreadyTrackedId = `autocomplete-click-${
    autoCompleteResult === null || autoCompleteResult === void 0
      ? void 0
