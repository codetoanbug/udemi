...
import { getSmartBarStore } from "./smart-bar-store.mobx-store";
 ...
 */
const SmartBarComponent = (props) => {
  var _props$disableHideBut, _smartBarStore$notice, _smartBarStore$notice2;
  const [smartBarStore, setSmartBarStore] = useState();
  const {
    me,
    Config,
    request,
  ...
  const disableHideButtonWhenVisible =
    (_props$disableHideBut = props.disableHideButtonWhenVisible) !== null &&
    _props$disableHideBut !== void 0
      ? _props$disableHideBut
      : false;
  useEffect(() => {
          ...
          const store = getSmartBarStore({
            params:
              typeof window !== "undefined"
                ? Object.fromEntries(
                    new URLSearchParams(
                      (_window$location = window.location) === null ||
  ...
  const onClickOptIn = useCallback(() => {
    if (
      !(
        smartBarStore !== null &&
        smartBarStore !== void 0 &&
        smartBarStore.optInJustApplied()
      )
    ) {
      smartBarStore === null || smartBarStore === void 0
        ? void 0
        : smartBarStore
            .optIn()
            .then(() => {
  ...
  const onClickCta = useCallback(() => {
    smartBarStore === null || smartBarStore === void 0
      ...
      : smartBarStore.sendClickEvent(
          smartBarStore === null || smartBarStore === void 0
            ? void 0
            : smartBarStore.data.get("cta_url"),
          "cta"
        );
  }, [smartBarStore]);
  function isSticky() {
    return props.forceNotSticky
      ? false
      : smartBarStore === null || smartBarStore === void 0
      ? void 0
      : smartBarStore.isSticky;
  }
  ...
  const shouldNotRender =
    ...
    (smartBarStore.isStickyPositionHidden &&
      props.hideWhenStickyPositionHidden); // Hide certain SmartBarSpacers when hidden_sticky=true)
  ...
  const smartBarClasses = classNames(
    isSticky() && !smartBarStore.isStickyPositionHidden
      ? styles["smart-bar--sticky"]
      : null,
    isMobile ? styles["smart-bar--mobile"] : null,
    (_smartBarStore$notice = smartBarStore.noticeType) === null ||
      _smartBarStore$notice === void 0
      ? void 0
      : _smartBarStore$notice
  ...
  const content = /*#__PURE__*/ React.createElement(BasicBarContent, {
    className: contentClasses,
    smartBarStore: smartBarStore,
    membership: smartBarStore.membership,
  });
  const optInButton = /*#__PURE__*/ React.createElement(
    "div",
    {
      className: ctaButtonWrapperClasses,
    },
  ...
  const linkButton = /*#__PURE__*/ React.createElement(
    "div",
    {
      className: ctaButtonWrapperClasses,
    },
  ...
  if (
    smartBarStore !== null &&
    smartBarStore !== void 0 &&
    (_smartBarStore$notice2 = smartBarStore.noticeType) !== null &&
    _smartBarStore$notice2 !== void 0 &&
    _smartBarStore$notice2.showOptIn &&
    !smartBarStore.membership.get("opt_in")
  ) {
    ctaButton = optInButton;
  } else if (smartBarCtaUrl) {
    ctaButton = linkButton;
  }
  const hideButton = /*#__PURE__*/ React.createElement(
    "div",
    null,
    smartBarStore.shouldRenderHideButton &&
      /*#__PURE__*/ React.createElement(
  ...
  let smartBar;
  if (isMobile) {
    smartBar = /*#__PURE__*/ React.createElement(
      "div",
      {
        className: smartBarClasses,
        "data-testid": "smart-bar",
      },
      /*#__PURE__*/ React.createElement(
        "div",
        {
  ...
  if (disableHideButtonWhenVisible) {
    ...
    smartBar = /*#__PURE__*/ React.createElement(Observer, options, smartBar);
  }
  if (props.muteEvents) {
...
export const SmartBarSpacer = (_ref) => {
  let { disableHideButtonWhenVisible = false, store = null, ...rest } = _ref;
  return /*#__PURE__*/ React.createElement(
    "div",
    {
...
//# sourceMappingURL=smart-bar.react-component.js.map
