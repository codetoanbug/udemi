...
let prevDocumentOverflow;
export const exceptionElements = new Set();
export const isIOS = !!(
...
export function lockPageScroll(exceptionElement) {
  let options =
...
export function unlockPageScroll(exceptionElement) {
  let options =
    arguments.length > 1 && arguments[1] !== undefined
      ? arguments[1]
      : {
...
function handleTouchScroll(event, target, initialClientY) {
...
//# sourceMappingURL=lock-page-scroll.js.map
