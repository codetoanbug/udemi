export function findFocusables(container) {
  ...
  let focusables = Array.from(container.querySelectorAll(focusableQuery)); // attributes we use to prune out elements that make a focusable element moot
  ...
  unfocusables.forEach((unfocusable) => {
    focusables = focusables.filter(
      (focusable) => !unfocusable.contains(focusable)
    );
  });
  return focusables;
}
//# sourceMappingURL=find-focusables.js.map
