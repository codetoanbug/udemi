...
import * as insightLinks from "./insights/links";
...
export const UTM_QUERY_PARAM_MKTO_FIELDS = {
  // Each [key] maps to a Query Param. It's value maps the Marketo field
  // E.g. ?utm_source=hi -> Campaign_Source_utm_source__c=hi
