...
export const ManageSubNavs = observer(() => {
  ...
  function renderL2ManageNav(l1NavItemId) {
    const { organizationManageMenu } = headerStore.userSpecificContext;
    const l1NavItem = organizationManageMenu.find(
      (item) => item.id === l1NavItemId
    );
    return (
      l1NavItem &&
      /*#__PURE__*/ React.createElement(MobileL2ManageNav, {
        l1NavItem: l1NavItem,
      })
    );
  }
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    hasL1 && /*#__PURE__*/ React.createElement(MobileL1ManageNav, null)
  );
});
//# sourceMappingURL=manage-sub-navs.react-component.js.map
