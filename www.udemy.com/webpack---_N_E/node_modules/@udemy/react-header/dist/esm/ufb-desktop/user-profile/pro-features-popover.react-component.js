...
import styles from "./pro-features-popover.module.css";
        ...
        BlockList.Item,
        {
          ...
          onClick: () =>
            Tracker.publishEvent(
              new OrganizationUserProFeatureUdemyPathSelectEvent({
                uiRegion,
              })
            ),
        },
    ...
    /*#__PURE__*/ React.createElement(
      ...
      /*#__PURE__*/ React.createElement(
        BlockList.Item,
        {
          ...
          onClick: () =>
            Tracker.publishEvent(
              new OrganizationUserProFeatureAssessmentSelectEvent({
                uiRegion,
              })
            ),
        },
    ...
    /*#__PURE__*/ React.createElement(
      ...
      /*#__PURE__*/ React.createElement(
        BlockList.Item,
        {
          ...
          onClick: () =>
            Tracker.publishEvent(
              new OrganizationUserProFeatureLabSelectEvent({
                uiRegion,
              })
            ),
        },
    ...
    /*#__PURE__*/ React.createElement(
      ...
      /*#__PURE__*/ React.createElement(
        BlockList.Item,
        {
          ...
          onClick: () =>
            Tracker.publishEvent(
              new OrganizationUserProFeatureWorkspaceSelectEvent({
                uiRegion,
              })
            ),
        },
...
//# sourceMappingURL=pro-features-popover.react-component.js.map
