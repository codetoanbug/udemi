...
export function getDefaultErrorMessage(gettext) {
...
function createAdditionalContextHeader() {
  try {
    ...
    if (contextRequested && !contextRequested.requires_api_call) {
      const headerValue = JSON.stringify(contextRequested.value);
      return {
...
export function fetchAllPages(firstUrl, params, config, _udApi) {
  /*
...
//# sourceMappingURL=ud-api.js.map
