...
export const MarketplaceOnly = (_ref) => {
  let { children } = _ref;
  const { Config: udConfig } = useUDData(); // To avoid potential "Uncaught Invariant Violation: MarketplaceOnly(...): Nothing was returned from render." errors
...
//# sourceMappingURL=marketplace-only.react-component.js.map
