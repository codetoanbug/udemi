...
import React from "react"; // Note: Badge CSS is served up via the react-form-components.global.css file;
...
export const Badge = (_ref) => {
  let { children = null, className, ...props } = _ref;
  return /*#__PURE__*/ React.createElement(
    "div",
    Object.assign({}, props, {
      className: classNames("ud-badge", "ud-heading-xs", className),
    }),
    children
  );
};
//# sourceMappingURL=badge.react-component.js.map
