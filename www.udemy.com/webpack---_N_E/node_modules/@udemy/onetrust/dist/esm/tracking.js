...
export function processOnConsentChanged() {
  ...
  if (consentChangedEvents && consentChangedEvents.length > 0) {
    for (const i in consentChangedEvents) {
      const consentEvent = consentChangedEvents[i];
