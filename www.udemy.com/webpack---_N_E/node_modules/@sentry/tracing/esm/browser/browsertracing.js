...
class BrowserTracing {
  ...
  _createRouteTransaction(context) {
    ...
    var parentContextFromHeader =
      context.op === "pageload" ? extractTraceDataFromMetaTags() : undefined;
...
function extractTraceDataFromMetaTags() {
  ...
  var sentrytraceData = sentrytraceValue
    ? extractTraceparentData(sentrytraceValue)
    : undefined;
