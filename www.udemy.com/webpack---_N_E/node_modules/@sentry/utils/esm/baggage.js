...
function serializeBaggage(baggage) {
  return Object.keys(baggage[0]).reduce((prev, key) => {
    ...
    var baggageEntry = `${SENTRY_BAGGAGE_KEY_PREFIX}${encodeURIComponent(
      key
...
function mergeAndSerializeBaggage(incomingBaggage, thirdPartyBaggageHeader) {
  ...
  var headerBaggage =
    (thirdPartyBaggageHeader &&
      parseBaggageHeader(thirdPartyBaggageHeader, true)) ||
    undefined;
  var thirdPartyHeaderBaggage =
    headerBaggage && getThirdPartyBaggage(headerBaggage);
