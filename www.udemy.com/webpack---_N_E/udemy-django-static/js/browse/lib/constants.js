...
export const PAGE_TYPE_COURSE_LANDING_PAGE_DISABLED_COURSE_LABEL =
  "disabled_course_label";
export const PAGE_TYPE_SEQUENCE_LANDING_PAGE = "series-landing-page";
export const PAGE_TYPE_COURSE_LANDING_PAGE_DISABLED_COURSE_CATEGORY =
  "disabled_course_category";
export const PAGE_TYPE_COURSE_LANDING_PAGE_FREE_COURSE =
  "landingPageFreeCourse";
