...
import {CarouselProps} from '@udemy/react-structure-components';
import {
    Instructor,
    InstructorCardProps,
} from 'udemy-django-static/js/browse/components/instructor-card/instructor-card.react-component';
