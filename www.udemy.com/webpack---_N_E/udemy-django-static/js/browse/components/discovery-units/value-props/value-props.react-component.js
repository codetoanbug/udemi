...
import { getNumericSiteStat } from "udemy-django-static/js/utils/site-stats";
...
class ValueProps extends Component {
  ...
  get isFirstVisitWithinSevenDays() {
    ...
    const timeToUse =
      firstVisitTime < userCreatedTime ? firstVisitTime : userCreatedTime;
  ...
  render() {
    ...
    // Note, `ud-full-width-container` provided by browse/app.global.less
    ...
    return (
      <div
        className={classNames(defaultStyles, styles.wrapper)}
