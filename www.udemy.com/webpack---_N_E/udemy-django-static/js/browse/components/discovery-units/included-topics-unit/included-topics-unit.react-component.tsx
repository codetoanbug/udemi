...
import {GradientScroll} from 'udemy-django-static/js/browse/components/discovery-units/included-topics-unit/gradient-scroll.react-component';

import styles from './included-topics-unit.module.less';
