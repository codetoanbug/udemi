...
import styles from "./sequence-unit.module.less";
...
class SequenceUnit extends React.Component {
  ...
  render() {
    ...
    const learningSeriesId =
      unit.source_objects.length > 0 ? unit.source_objects[0].id : "";
                ...
                >
                  <>
                    <div className={styles["order-line"]}>
                      <span
                        className={classNames("ud-heading-xs", styles.order)}
                      >
                        {index + 1}
                      </span>
