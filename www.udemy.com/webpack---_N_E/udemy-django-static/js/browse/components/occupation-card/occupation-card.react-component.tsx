...
import {CollectionStats} from 'udemy-django-static/js/browse/components/collection-stats/collection-stats.react-component';
import {OccupationUnitItem} from 'udemy-django-static/js/browse/components/discovery-units/related-occupations-unit/related-occupations-unit.react-component';

import styles from './occupation-card.module.less';
...
export const OccupationCard = ({
    ...
    const {trackOccupationCardImpressionEvent, trackOccupationCardClickEvent} =
