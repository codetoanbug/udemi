...
import udLink from "udemy-django-static/js/utils/ud-link";
...
import { LabsResumeBannerOpenWorkspaceClickEvent } from "./events/labs-resume-banner-open-workspace-click-event";
...
export const LAB_TRACKING_EVENTS = Object.freeze({
  ...
  RESUME_BANNER_CONTINUE_CLICK: LabsResumeBannerContinueClickEvent,
  ...
  RESUME_BANNER_OPEN_WORKSPACE_CLICK: LabsResumeBannerOpenWorkspaceClickEvent,
});
