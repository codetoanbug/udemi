...
export const pollForAutomatedReviewResultsApiUrl = (
  labId,
  labTaskId,
  testRunUuid
) => {
  return `${requestAutomatedReviewApiUrl(
    labId,
    labTaskId
  )}${testRunUuid}/results/`;
};
...
export const labReportIssueUrl = (labId) =>
  `${labBaseApiUrl(labId)}report-technical-issue/`;
