...
import {AutomatedReviewTestApiData} from 'udemy-django-static/js/lab-manage/types';
import {labTasksApiUrl} from 'udemy-django-static/js/labs/apis';
import BaseLabResource from 'udemy-django-static/js/labs/base-lab-resource.mobx-model';
import LabTask from 'udemy-django-static/js/labs/lab-task.mobx-model';
