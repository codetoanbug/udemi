...
export const UDEMYKOREA_BUSINESS_PATH =
  "https://udemy.wjtb.co.kr/insight/index";

export const UDEMYKOREA_BUSINESS_DEMO_PATH =
  "https://info.udemy.com/KR_ContactUs.html";
...
export const buyMoreLicensesLink = (plan) => {
  const links = {
    ...
    [PACKAGE_PLANS.ENTERPRISE]: udLink.toSupportLink(
...
export const resourceRedirectURL = (resourceId) => ({
  [RESOURCE_TYPES.COURSE]: insightLinks.absolute(
    insightLinks.toCourseDetails(resourceId)
  ),
  [RESOURCE_TYPES.LEARNING_PATH]: insightLinks.absolute(
    insightLinks.toPathDetails(resourceId)
  ),
  [RESOURCE_TYPES.LAB]: insightLinks.absolute(insightLinks.toProInsights()),
  [RESOURCE_TYPES.ASSESSMENT]: insightLinks.absolute(
    insightLinks.toProInsights()
  ),
});
