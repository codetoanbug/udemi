...
} from "udemy-django-static/js/course-landing-page/components/confirmation-bottom-drawer/constants";
...
export function getConfirmationBottomDrawerMessages() {
  return {
    title: {
      ...
      [CONFIRMATION_BOTTOM_DRAWER_LOADING_STATE]: gettext(
        "Add course to wishlist?"
      ),
      [CONFIRMATION_BOTTOM_DRAWER_FINISHED_STATE]: gettext(
