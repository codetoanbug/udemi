...
import {ReactSubscriptionCTAContext} from 'src/contexts/subscription-cta-experiment-context';

import styles from './plan-period.module.less';
...
export const PlanPeriod = ({
    ...
    if (showCancelAnytime) {
        ...
        return (
            <div>
                <div className={styles[planPeriodStyle]}>{planPeriodText}</div>
                <div className={styles[cancelAnytimeStyle]}>
