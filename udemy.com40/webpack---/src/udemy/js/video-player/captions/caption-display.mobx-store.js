...
export default class CaptionDisplayStore {
    ...
    constructor(controlBarStore, captionsStore, videoPlayerStore) {
    ...
    attachPlayer(player) {
        this.player = player;
        player.on('timeupdate', this.calculateCuePosition);
    }
