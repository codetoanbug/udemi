 ...
 */
class LearningListCreateEvent extends ClientEvent {
    listId: number;
    nonInteraction: boolean;
    uiRegion: string;
 ...
 */
class LearningListDeleteEvent extends ClientEvent {
    listId: number;
    uiRegion: string;
 ...
 */
class LearningListEditEvent extends ClientEvent {
    listId: number;
    uiRegion: string;
    constructor({listId, uiRegion}: ListEventProps) {
 ...
 */
class LearningListItemRemoveEvent extends ClientEvent {
    listId: number;
    uiRegion: string;
    courseId: number;
    trackingId: string;
 ...
 */
class LearningListItemSaveEvent extends ClientEvent {
    listId: number;
    uiRegion: string;
    courseId: number;
    trackingId: string;
