...
export interface AssessmentShareToSlackPreviewProps {
    data: {
        author_name: string;
        author_icon: string;
        title: string;
...
/**
 * This component is used when sharing Assessment to Slack because we need to set the image at the bottom
 * instead of having it at the left side, as in the Recommend and Assign.
 */

export const AssessmentShareToSlackPreview = ({data}: AssessmentShareToSlackPreviewProps) => {
    return (
        <>
                ...
                <div styleName="info-completion-time share-to-slack">
                    ...
                    <div styleName="icon-container share-to-slack">
                        <AssignmentIcon
                            label={false}
                            size="xlarge"
                            styleName="card-icon assessment"
                        />
                    </div>
                </div>
            </div>
